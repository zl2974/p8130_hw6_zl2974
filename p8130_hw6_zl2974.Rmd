...
different trend by ethnic groups. We hypothesis that there's difference in 
 relationship between BMI and serum estradiol by ethnicity.
...
hypothesis and conclude that the coefficient of ethnic is not equal to 0.
...
the range of BMI, we hypothesis that there the BMI might have interaction with 
ethnic groups.
